...
elBtn1.addEventListener('click', ()=>{
    ...
    if(elInp1.value == ''){
        elSuccess1.textContent = 'Siz isim kiritmadingiz'
        ...
        elSuccess1.textContent = 'Ismingiz xato kiritildi'
        elSuccess1.style.color = 'red'
    }
    if(elInp2.value == ''){
        elSuccess2.textContent = 'Siz mashina raqamingizni kiritmadingiz'
        ...
        elSuccess2.textContent = 'Mashina raqamingiz xato kiritildi'
        elSuccess2.style.color = 'red'
    }
    if(elInp3.value.length == ''){
        elSuccess3.textContent = 'Siz parol kiritmadingiz'
        ...
        elSuccess3.textContent = 'Parolni xato kiritdingiz'
        elSuccess3.style.color = 'red'
    }
    if(elInp3.value == elInp4.value){
        elSuccess4.textContent = ''
    }else if(elInp4.value.length == elInp3.value){
        elSuccess4.textContent = 'Parolni qayta kiritmadingiz'
